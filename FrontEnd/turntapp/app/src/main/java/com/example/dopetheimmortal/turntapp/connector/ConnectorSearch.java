 ...
 */
public class ConnectorSearch extends AsyncTask<String, String, String> {
    String link;
    ConnectorCallSearch callback;
    ...
    public ConnectorSearch(String link, ConnectorCallSearch callback, Context cont, HashMap<String,String> data, String prg_title, String prg_message, boolean prg_dissmis, boolean show){
        this.data=data;
