 ...
 */
public class ConnectorInvite extends AsyncTask<String, String, String> {
    String link;
    ConnectorCallbackInvite callback;
    ...
    ImageView imageView;
    public ConnectorInvite(String link, ConnectorCallbackInvite callback, Context cont, HashMap<String,String> data, String prg_title, String prg_message, boolean prg_dissmis, boolean show, ImageView imageView){
        this.data=data;
