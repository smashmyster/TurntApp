...
public class Connector extends AsyncTask<String, String, String> {
    ...
    public Connector(String link, Scanner callback, Context cont, HashMap<String,String> data, String prg_title, String prg_message, boolean prg_dissmis, boolean show){
        this.data=data;
